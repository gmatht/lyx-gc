...
[".Capital",'[.][[:upper:]][^.]',"", 'Perhaps you should put a space between the . and the capital'],
...
["Classic[al] Logic", '\b[Cc]lassic\s+[Ll]ogic\b', "", "Did you mean Classical Logic (also called Propositional Calculus)?"], 
